        ...
        <div className='-mx-4 flex flex-wrap items-center'>
          <div className='w-full px-4 lg:w-6/12 xl:w-7/12'>
            <div className='mb-[60px] lg:mb-[100px] xl:mb-[150px]'>
              <span className='mb-6 inline-block rounded-full px-3 py-1 text-sm font-semibold leading-6 text-white ring-1 ring-inset ring-white'>
                Contact us
              </span>

              <h2 className='text-[35px] font-semibold leading-tight text-white'>
                Let’s talk about <br />
                your problem.
              </h2>
            </div>
                  ...
                  <div className='flex'>
                    ...
                    <div>
                      ...
                      <p className='text-base text-body-color dark:text-dark-6'>
                        155 Emirates Street, San Francisco, CA 940132
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className='w-full px-4 lg:w-6/12 xl:w-5/12'>
            <div className='rounded-lg bg-white px-8 py-12 shadow-3 dark:bg-dark-2 sm:p-[60px] lg:px-12 xl:p-[60px] shadow-lg'>
